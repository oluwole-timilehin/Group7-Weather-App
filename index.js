...
//       // 2. Then Get the Weather (Passing the GPS coords)
...
// const cityNameList = document.getElementById("cityNameList");
// let locationUi = document.getElementById("location");
...
// // You need to add "url()" around the link
// // document.body.style.backgroundImage = `url('${nightBackground.snow}')`;
...
//   const formattedDate = `${time} - ${dayName}, ${dayNumber} ${month} '${year}`;
//   document.getElementById("dateDisplay").innerText = formattedDate;
// }

// // Function to format ONLY the date (returns the string)
// function formatDateOnly(apiDateString) {
//   const date = new Date(apiDateString);

//   // 1. Extract the day of the week (e.g., "Monday")
//   const dayName = date.toLocaleDateString("en-US", { weekday: "long" });

//   // 2. Extract the day number (e.g., "9")
//   const dayNumber = date.getDate();

//   // 3. Extract the short month name (e.g., "Sep")
//   const month = date.toLocaleDateString("en-US", { month: "short" });

//   // 4. Extract the short year (e.g., "'23")
//   const year = date.getFullYear().toString().slice(-2);

//   // 5. Return the formatted string (No time included)
...
//   // Call the unified function with the search coordinates
//   getWeatherInfo(lat, long);
// });

// // --- 4. THE UNIFIED WEATHER FUNCTION ---
// // --- 4. THE UNIFIED WEATHER FUNCTION ---
...
//       locationUi.textContent = "Current Location";
//     } else {
//       locationUi.innerText = locationDetails;
//     }
...
//     // (Kept your ID mapping exactly as is)
...
//     // --- ICON & NIGHT LOGIC START ---

//     // FIX: Use 'data.current.time' (not current_weather)
...
//     console.log("Is it Night?", isNightTime(serverTime));

//     console.log("Weather Code:", code, "Server Time:", serverTime);
...
//       console.log("Night Mode: ON"); // Debug
//       if (weather.text === "Thunderstorm") {
//         document.body.style.backgroundImage = `url('${nightBackground.thunderstorm}')`; // Update this link if you have a storm one
//       } else if (weather.text === "Rain") {
//         document.body.style.backgroundImage = `url('${nightBackground.rain}')`;
//       } else if (weather.text === "Cloudy") {
//         document.body.style.backgroundImage = `url('${nightBackground.cloudy}')`;
//       } else if (weather.text === "Clear Night") {
//         document.body.style.backgroundImage = `url('${nightBackground.clear}')`;
//       } else if (weather.text === "Snow") {
//         document.body.style.backgroundImage = `url('${nightBackground.snow}')`;
//       }
//     } else if (weather.text === "Thunderstorm") {
//       document.body.style.backgroundImage = `url('${dayBackground.rain}')`; // Update this link if you have a storm one
//     } else if (weather.text === "Rain") {
//       document.body.style.backgroundImage = `url('${dayBackground.rain}')`;
//     } else if (weather.text === "Cloudy") {
//       document.body.style.backgroundImage = `url('${dayBackground.cloudy}')`;
//     } else if (weather.text === "Clear Night") {
//       document.body.style.backgroundImage = `url('${dayBackground.clear}')`;
//     } else if (weather.text === "Snow") {
//       document.body.style.backgroundImage = `url('${dayBackground.snow}')`;
//     } else if (weather.text === "Extreme Heat") {
//       document.body.style.backgroundImage = `url('${dayBackground.sunny}')`;
//     } else if (weather.text === "Sunny") {
//       document.body.style.backgroundImage = `url('${dayBackground.sunny}')`;
//     }
...
//       //     console.log("Night Mode: ON"); // Debug
//       //     if (weather.text === "Thunderstorm") {
//       //       document.body.style.backgroundImage = `url('${nightBackground.cloudy}')`; // Update this link if you have a storm one
//       //     } else if (weather.text === "Rain") {
//       //       document.body.style.backgroundImage = `url('${nightBackground.rain}')`;
//       //     } else if (weather.text === "Cloudy") {
//       //       document.body.style.backgroundImage = `url('${nightBackground.cloudy}')`;
...
//       //     }
//       //   } else {
//       //     // Optional: Add an 'else' here to reset the background for Day time!
//       //     document.body.style.backgroundImage = `url('${nightBackground.snow}')`; // Or your day background
//       //   }
...
//     // Logic Function (Inside or Outside is fine, keeping it here as you had it)
...
// // --- NIGHT CHECKER HELPER ---
// function isNightTime(serverDateString) {
//   // Parses "2026-01-15T20:00" and extracts the hour (0-23)
//   const dateObj = new Date(serverDateString);
//   const hour = dateObj.getHours();

//   // If before 6am OR after 6pm (18:00)
//   if (hour < 6 || hour >= 18) {
//     return true; // Night
//   } else {
//     return false; // Day
